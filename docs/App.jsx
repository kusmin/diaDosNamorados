          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                desc: "Nossos primeiros encontros foram como a formação das primeiras estrelas no cosmos - cheios de energia, brilho e a promessa de algo grandioso por vir."
              },
              {
                title: "O Nascimento das Constelações",
                desc: "Quando nos tornamos oficialmente um casal, foi como se as 88 constelações finalmente encontrassem suas posições definitivas no céu."
              },
              {
